...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	?>
		<header>
			<h1 class="page-title screen-reader-text mdc-card mdc-card--outlined"><?php single_post_title(); ?></h1>
		</header>
	<?php
	endif;
	?>
	...
	<?php alphagames_post_thumbnail(); ?>

	<div class="entry-content">
		<?php if (!is_front_page()) : ?>
			<div class="mdc-card mdc-elevation--z24 mdc-card--outlined post-card mdc-typography post-card__secondary">
				<?php
				the_content(); ?>
			<?php else : ?>
				<?php the_content() ?>
				...
				<div class="mdc-layout-grid">
					<div class="mdc-layout-grid__inner">
						<div class="mdc-layout-grid__cell--span-12">
							<section class="hero">
								<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1527.38 670.64">
									<defs>
										<style>
											.cls-1,
											.cls-2 {
					...
					<div class="divider">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1850 107">
							<defs>
								<style>
									.instoreeventsdvider-cls-1,
									.instoreeventsdvider-cls-4 {
										fill: #ffc444;
									}

									.instoreeventsdvider-cls-2 {
										font-size: 80px;
										fill: #8a130c;
										font-family: SWTORTrajan, SWTOR Trajan;
									}

									.instoreeventsdvider-cls-3 {
							...
							<g id="Layer_2" data-name="Layer 2">
								<g id="Layer_1-2" data-name="Layer 1">
									<path class="instoreeventsdvider-cls-1" d="M0,107l810.57-.5L896,0H0Z" /><text class="instoreeventsdvider-cls-2" transform="translate(22.1 85.57)">IN STORE EVENTS</text>
									<path class="instoreeventsdvider-cls-4" d="M865.61,107H841.5L927.9.5H950Z" />
									<path class="instoreeventsdvider-cls-4" d="M919.61,107H895.5L981.9.5H1004Z" />
									<path class="instoreeventsdvider-cls-4" d="M970.61,107H946.5L1032.9.5H1055Z" />
									<path class="instoreeventsdvider-cls-4" d="M1024.61,107H1000.5L1086.9.5H1109Z" />
									<path class="instoreeventsdvider-cls-4" d="M1078.61,107H1054.5L1140.9.5H1163Z" />
									<path class="instoreeventsdvider-cls-4" d="M1129.61,107H1105.5L1191.9.5H1214Z" />
									<path class="instoreeventsdvider-cls-4" d="M1183.61,107H1159.5L1245.9.5H1268Z" />
									<path class="instoreeventsdvider-cls-4" d="M1237.61,107H1213.5L1299.9.5H1322Z" />
									<path class="instoreeventsdvider-cls-4" d="M1288.61,107H1264.5L1350.9.5H1373Z" />
									<path class="instoreeventsdvider-cls-4" d="M1342.61,107H1318.5L1404.9.5H1427Z" />
									<path class="instoreeventsdvider-cls-4" d="M1396.61,107H1372.5L1458.9.5H1481Z" />
									<path class="instoreeventsdvider-cls-4" d="M1447.61,107H1423.5L1509.9.5H1532Z" />
									<path class="instoreeventsdvider-cls-4" d="M1501.61,107H1477.5L1563.9.5H1586Z" />
									<path class="instoreeventsdvider-cls-4" d="M1555.61,107H1531.5L1617.9.5H1640Z" />
									<path class="instoreeventsdvider-cls-4" d="M1606.61,107H1582.5L1668.9.5H1691Z" />
									<path class="instoreeventsdvider-cls-4" d="M1660.61,107H1636.5L1722.9.5H1745Z" />
									<path class="instoreeventsdvider-cls-4" d="M1714.61,107H1690.5L1776.9.5H1799Z" />
									<path class="instoreeventsdvider-cls-4" d="M1765.61,107H1741.5L1827.9.5H1850Z" />
								</g>
							</g>
						</svg>
					</div>
					<div class="mdc-layout-grid__inner">
						...
						$fbevents = new WP_Query($args);
						if ($fbevents->have_posts()) :

							while ($fbevents->have_posts()) :
						...
						?>
								...
								<div class="mdc-layout-grid__cell--span-4">
									<div class="mdc-card mdc-elevation--z24 mdc-card--outlined post-card" data-aos="fade-up" data-aos-once="true">
										<div class="mdc-card__primary-action" tabindex="0">

											<div class="mdc-card__media mdc-card__media--16-9 mdc-card__media" style="background-image: url(<?php the_post_thumbnail_url(); ?>)">
												<a href="<?php the_permalink() ?>"></a>
												<div class="mdc-card__primary post-card__primary fp-title">
													<h1 class="mdc-card__title mdc-typography mdc-typography--subtitle1 post-card__title fp-heading"><?php the_title(); ?></h1>
												</div>
											</div>
											...
											<div class="mdc-card__action-buttons">
												<?php if (is_front_page()) : ?>
													<a href="<?php the_permalink() ?>">
														<button class="mdc-button mdc-card__action mdc-card__action--button"><i class="material-icons mdc-button__icon">fullscreen</i><span class="mdc-button__label">Full Page</span></button>
													</a>
												<?php
												endif;
												?>
					...
					<div class="mdc-layout-grid__cell--span-12" id="about">
						<div class="about-divider">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1850 107">
								...
								<g id="Layer_2" data-name="Layer 2">
									<g id="Layer_1-2" data-name="Layer 1">
										<path class="instoreeventsdvider-cls-1" d="M0,107l810.57-.5L896,0H0Z" /><text class="instoreeventsdvider-cls-2" transform="translate(22.1 85.57)">ABOUT ALPHA</text>
										<path class="instoreeventsdvider-cls-4" d="M865.61,107H841.5L927.9.5H950Z" />
										<path class="instoreeventsdvider-cls-4" d="M919.61,107H895.5L981.9.5H1004Z" />
										<path class="instoreeventsdvider-cls-4" d="M970.61,107H946.5L1032.9.5H1055Z" />
										<path class="instoreeventsdvider-cls-4" d="M1024.61,107H1000.5L1086.9.5H1109Z" />
					...
					<div class="mdc-layout-grid__cell--span-12">
						<div data-aos="fade-up" data-aos-once="true">
							<div class="mdc-typography">
								<div class="mdc-layout-grid__inner">
									<div class="mdc-layout-grid__cell--span-6 about1">
										<img src="<?php bloginfo('stylesheet_directory') ?>/images/Alpha_Hero1920x1080.png" />
									</div>
									<div class="mdc-card mdc-layout-grid__cell--span-6 about2" style="border-radius: 0px;">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1850 107">
											<defs>
												<style>
													.text-header-cls-1,
											...
											<title>Asset 2eventsdivider</title>
											<g id="Layer_2" data-name="Layer 2">
												<g id="Layer_1-2" data-name="Layer 1">
													<path class="text-header-cls-1" d="M1850,107l-810.57-.5L954,0h896Z" />
													<path class="text-header-cls-2" d="M984.39,107h24.11L922.1.5H900Z" />
													<path class="text-header-cls-2" d="M930.39,107H954.5L868.1.5H846Z" />
													<path class="text-header-cls-2" d="M879.39,107H903.5L817.1.5H795Z" />
													<path class="text-header-cls-2" d="M825.39,107H849.5L763.1.5H741Z" />
													<path class="text-header-cls-2" d="M771.39,107H795.5L709.1.5H687Z" />
													<path class="text-header-cls-2" d="M720.39,107H744.5L658.1.5H636Z" />
													<path class="text-header-cls-2" d="M666.39,107H690.5L604.1.5H582Z" />
													<path class="text-header-cls-2" d="M612.39,107H636.5L550.1.5H528Z" />
													<path class="text-header-cls-2" d="M561.39,107H585.5L499.1.5H477Z" />
													<path class="text-header-cls-2" d="M507.39,107H531.5L445.1.5H423Z" />
													<path class="text-header-cls-2" d="M453.39,107H477.5L391.1.5H369Z" />
													<path class="text-header-cls-2" d="M402.39,107H426.5L340.1.5H318Z" />
													<path class="text-header-cls-2" d="M348.39,107H372.5L286.1.5H264Z" />
													<path class="text-header-cls-2" d="M294.39,107H318.5L232.1.5H210Z" />
													<path class="text-header-cls-2" d="M243.39,107H267.5L181.1.5H159Z" />
													<path class="text-header-cls-2" d="M189.39,107H213.5L127.1.5H105Z" />
													<path class="text-header-cls-2" d="M135.39,107H159.5L73.1.5H51Z" />
													<path class="text-header-cls-2" d="M84.39,107H108.5L22.1.5H0Z" />
												</g>
											</g>
										</svg>
										<div class="text-wrapper post-card__secondary">
											<p class="mdc-typography--body1" style="font-size: 1.75rem; line-height: 1.75rem;">
												Alpha Games is a family business that aims to combine our enthusiasm for tabletop gaming, models, painting and trading card games with a desire to provide outstanding customer service and build a community where newcomers and long standing enthusiasts can come together and share a passion for gaming.
											</p>
										</div>
									</div>
								</div>
					...
					<div class="mdc-layout-grid__cell--span-12">
						<div data-aos="fade-up" data-aos-once="true">
							<div class="mdc-typography">
								<div class="mdc-layout-grid__inner">
									<div class="mdc-card mdc-layout-grid__cell--span-6 about4" style="border-radius: 0px;">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1850 107">
											<defs>
												<style>
													.text-header-left-margin-cls-1,
													.text-header-left-margin-cls-2 {
														fill: #ffc444;
													}
											...
											<title>Asset 3eventsdivider</title>
											<g id="Layer_2" data-name="Layer 2">
												<g id="Layer_1-2" data-name="Layer 1">
													<path class="text-header-left-margin-cls-1" d="M0,107l810.57-.5L896,0H0Z" />
													<path class="text-header-left-margin-cls-2" d="M865.61,107H841.5L927.9.5H950Z" />
													<path class="text-header-left-margin-cls-2" d="M919.61,107H895.5L981.9.5H1004Z" />
													<path class="text-header-left-margin-cls-2" d="M970.61,107H946.5L1032.9.5H1055Z" />
													<path class="text-header-left-margin-cls-2" d="M1024.61,107H1000.5L1086.9.5H1109Z" />
													<path class="text-header-left-margin-cls-2" d="M1078.61,107H1054.5L1140.9.5H1163Z" />
													<path class="text-header-left-margin-cls-2" d="M1129.61,107H1105.5L1191.9.5H1214Z" />
													<path class="text-header-left-margin-cls-2" d="M1183.61,107H1159.5L1245.9.5H1268Z" />
													<path class="text-header-left-margin-cls-2" d="M1237.61,107H1213.5L1299.9.5H1322Z" />
													<path class="text-header-left-margin-cls-2" d="M1288.61,107H1264.5L1350.9.5H1373Z" />
													<path class="text-header-left-margin-cls-2" d="M1342.61,107H1318.5L1404.9.5H1427Z" />
													<path class="text-header-left-margin-cls-2" d="M1396.61,107H1372.5L1458.9.5H1481Z" />
													<path class="text-header-left-margin-cls-2" d="M1447.61,107H1423.5L1509.9.5H1532Z" />
													<path class="text-header-left-margin-cls-2" d="M1501.61,107H1477.5L1563.9.5H1586Z" />
													<path class="text-header-left-margin-cls-2" d="M1555.61,107H1531.5L1617.9.5H1640Z" />
													<path class="text-header-left-margin-cls-2" d="M1606.61,107H1582.5L1668.9.5H1691Z" />
													<path class="text-header-left-margin-cls-2" d="M1660.61,107H1636.5L1722.9.5H1745Z" />
													<path class="text-header-left-margin-cls-2" d="M1714.61,107H1690.5L1776.9.5H1799Z" />
													<path class="text-header-left-margin-cls-2" d="M1765.61,107H1741.5L1827.9.5H1850Z" />
												</g>
											</g>
										</svg>
										<div class="text-wrapper post-card__secondary">
											<p class="mdc-typography--body1" style="font-size: 1.75rem; line-height: 1.75rem;">
												Alpha Games has a wide variety of stock in store including popular well known tabletop games such as Warhammer 40k, Age of Sigmar, Blood Bowl, Magic the Gathering, Bolt Action, X-Wing and also more niche offerings.
											</p>
											<p class="mdc-typography--body1" style="font-size: 1.75rem; line-height: 1.75rem;">
									...
									<div class="mdc-layout-grid__cell--span-6 about3">
										<img src="<?php bloginfo('stylesheet_directory') ?>/images/stock-image.jpg" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="mdc-layout-grid__cell--span-12">
						<div data-aos="fade-up" data-aos-once="true">
							<div class="mdc-typography">
								<div class="mdc-layout-grid__inner">
									<div class="mdc-layout-grid__cell--span-6 about5">
										<img src="<?php bloginfo('stylesheet_directory') ?>/images/gaming-table.jpg" />
									</div>
									<div class="mdc-card mdc-layout-grid__cell--span-6 about6" style="border-radius: 0px;">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1850 107">
											<defs>
												<style>
													.text-header-cls-1,
										...
										<div class="text-wrapper post-card__secondary">
											<p class="mdc-typography--body1" style="font-size: 1.75rem; line-height: 1.75rem;">
												Our store also provides a number of gaming tables that are open for public use, one room for card and board games and a larger room with larger tables for war games etc.
											</p>
										</div>
									</div>
								</div>
			...
			<?php if (get_edit_post_link()) : ?>
				<footer class="entry-footer">
					...
					edit_post_link(
						...
						'<button class="mdc-button"><span class="edit-link">',
						'</span></button>'
					);
					?>
				</footer><!-- .entry-footer -->
